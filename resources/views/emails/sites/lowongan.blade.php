                                    ...
                                    <div style="width:100% !important;">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Dear <strong>Subscription mail</strong>,</span>
                                                    </p>
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Kami mempunyai lowongan terbuka di BTSA
                                                            LOGISTICS.<br><br>Posisi yang terbuka pada saat ini adalah:
                                                            <br>
                                                            <b>{{$lokerID->posisi}}</b><br>
                                                            Dibuat pada tanggal:<br>
                                                            {{$lokerID->created_at}}<br><br>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <p style="text-align: left;  word-break: break-word;   margin: 0;">
                                                        <span style="">Jika anda merasa, anda cocok pada posisi
                                                            tersebut, silahkan submit lamaran anda pada situs kami. <br>
                                                            <a href="https://btsa.co.id/candidate">Submit your data
                                                                here.</a></span></p>
                                                </div>
                                            </div>
                                            <div
                                                ...
                                                <div style="   font-family: Helvetica, sans-serif; ">
                                                    <small class="text-muted">Anda menerima email ini sebagai
                                                        pemberitahuan
                                                        tentang adanya
                                                        lowongan baru dalam perusahaan BTSA LOGISTICS.</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
