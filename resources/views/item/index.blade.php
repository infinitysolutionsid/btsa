...
@section('title','Legality managements')
@section('content')
<div class="card">
    <div class="card-title">
        ...
        <a href="#addlegal">
            <button type="button" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5 float-right"
                data-toggle="modal" data-target="#addlegal">
            ...
            <table id="legaltables" class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{$dt_item->file}}" target="_blank"><span class="badge badge-primary">Download this
                                    legal document</span></a></td>
                        <td>{{$dt_item->updated_at}}</td>
                        @if(auth()->user()->role=='administrator')
                        <td><a href="/legal/{{$dt_item->legal_id}}/edit"><button class="btn btn-rounded btn-warning"><i
                                        class="fas fa-edit"></i></button></a> <a
                                href="/legal/{{$dt_item->legal_id}}/delete"><button
