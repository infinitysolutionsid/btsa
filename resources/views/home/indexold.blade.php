        ...
        <div class="container-fluid text-center">
            <div class="row">
                ...
                <div class="col-sm-4 text-left">
                    ...
                    <p><strong>Bali</strong><br>Jl. Raya Dalung Abianbase No 109<br>Kuta Utara, Dalung - Bali 80531<br>
                        <span class="glyphicon glyphicon-phone-alt"></span><a href="tel:03619094168"
                            style="text-decoration:none; color:#fff"> (0361) 9094168</a><br>
                        <span class="glyphicon glyphicon-envelope"></span><a href="mailto:market@btsa.co.id"
                            style="text-decoration:none; color:#fff"> market@btsa.co.id</a></p>
                </div>
                <div class="col-sm-4 text-left">
