                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="nama_lengkap">Quotes By</label>
                            <input type="text" class="form-control" name="nama_lengkap"
                                value="{{$data_quote->quotes_by}}" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{!!$data_quote->quotes_id!!}"
                                name="quotes_id" readonly>
                        </div>
                        <div class="form-group">
