...
@section('title','Jadwal kapal managements')
@section('content')
<div class="card">
    <div class="card-title">
        <h4>Jadwal Kapal Managements</h4>
        <a href="#addjadwalkapal">
            <button type="button" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5 float-right"
                data-toggle="modal" data-target="#addjadwalkapal">
            ...
            <table id="jadwal" class="table table-hover ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$dt_cat->etd}}</td>
                        <td>{{$dt_cat->eta}}</td>
                        <td><a href="/jadwal/{{$dt_cat->id}}/edit"><button
                                    class="btn btn-rounded btn-warning">Edit</button></a> <a
                                href="/jadwal/{{$dt_cat->id}}/delete"><button
...
<!-- Modal -->
<div class="modal fade" id="addjadwalkapal" tabindex="-1" role="dialog" aria-labelledby="addjadwalkapal"
    aria-hidden="true">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="vessel" id="vessel" class="form-control">
                                            ...
                                            @endforeach
                                            @else
                                            <option value="#" class="text-center" disabled>- No data vessel found -
                                            </option>
                                            @endif
                                        </select>
                                    </div>
